                        ...
                        <div className="tab-content">
                            ...
                            <div className="tab-pane" id="tabs-4" role="tabpanel">
                                <div className="product__details__pic__item">
                                    ...
                                    <Link to="https://www.youtube.com/watch?v=8PJ3_p7VqHw&list=RD8PJ3_p7VqHw&start_radio=1"
                                     className="video-popup"><i className="fa fa-play"></i></Link>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div className="container">
          ...
          <div className="row">
                <div className="col-lg-3 col-md-6 col-sm-6 col-sm-6">
                  {products.map( prod => (  <div className="product__item">
